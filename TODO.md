...
### Phase 8: 前端与可视化 (已完成)
- [x] **架构集成**: React + Vite + Material UI，通过 Maven 插件自动构建并嵌入 Spring Boot JAR。
- [x] **审计仪表盘**: 可视化展示 Token 消耗趋势与模型成本 (UI + API)。
- [x] **知识库管理 UI**: 文件上传、文档列表展示 (UI + API)。

---
*注：本项目已完成全部计划阶段的核心功能开发。*
